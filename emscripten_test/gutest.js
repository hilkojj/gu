...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'out/gutest.data';
    var REMOTE_PACKAGE_BASE = 'gutest.data';
...
Module['FS_createPath']('/assets', 'shaders', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_out/gutest.data');

    };
    Module['addRunDependency']('datafile_out/gutest.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 162868, "filename": "/assets/models/example.ubj"}, {"start": 162868, "audio": 0, "end": 162992, "filename": "/assets/shaders/normaltest.frag"}, {"start": 162992, "audio": 0, "end": 163244, "filename": "/assets/shaders/test.vert"}, {"start": 163244, "audio": 0, "end": 163344, "filename": "/assets/shaders/test.frag"}], "remote_package_size": 163344, "package_uuid": "fa7bcbc3-bcce-4dce-962d-f9fbd20ca1c1"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5293104,
    DYNAMIC_BASE = 5293104,
    DYNAMICTOP_PTR = 50192;
...
var wasmBinaryFile = 'gutest.wasm';
