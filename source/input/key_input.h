...
inline const std::map<int, const char *> KEY_NAMES = {
    ...
    {GLFW_KEY_KP_DECIMAL, "Numpad Decimal"},
    {GLFW_KEY_KP_DIVIDE, "Numpad Divide"},
    {GLFW_KEY_KP_MULTIPLY, "Numpad Multiply"},
    {GLFW_KEY_KP_SUBTRACT, "Numpad Subtract"},
    {GLFW_KEY_KP_ADD, "Numpad Add"},
    {GLFW_KEY_KP_ENTER, "Numpad Enter"},
    {GLFW_KEY_KP_EQUAL, "Numpad Equal"},
